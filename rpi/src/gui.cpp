...
//
//  Maybe NanoGui SDL   (tesing in sdl2_opengl) is best bet?
//

//fred
#include "rpi/nuklear.h"
#include "rpi/nuklear_sdl_gles2.h"
#include "rpi/gui.h"
...
MainLoop(void* loopArg){
    ...
    while (SDL_PollEvent(&evt)) {
        ...
        //if (evt.type == SDL_JOYBUTTONDOWN) printf("Apa\n");
        if (evt.type == SDL_CONTROLLERBUTTONDOWN) printf("apa\n");
        ...
        NK_WINDOW_CLOSABLE|NK_WINDOW_MINIMIZABLE))
    {
        ...
        if (nk_button_label(ctx, "button3"))
            fprintf(stdout, "button3 pressed\n");
        
        nk_edit_focus(ctx, NK_EDIT_NO_CURSOR);
